...
echo ""
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}              RALPH LOOP (Google Gemini) STARTING            ${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
while true; do
    ...
    OUTPUT_FILE="$LOG_DIR/ralph_gemini_output_iter_${ITERATION}_$(date '+%Y%m%d_%H%M%S').txt"
    RLM_STATUS="unknown"
    : > "$LOG_FILE"
    WATCH_PID=""
    ...
    if [ -n "$RLM_CONTEXT_FILE" ]; then
        EFFECTIVE_PROMPT_FILE="$LOG_DIR/ralph_gemini_prompt_iter_${ITERATION}_$(date '+%Y%m%d_%H%M%S').md"
